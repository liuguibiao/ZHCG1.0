(function ($) {
    ...
    $.extend(true, myflow.config.tools.states, {
        start: {
            ...
            props: {
                name: { name: 'name', label: '姓名', value: '', editor: function () { return new myflow.editors.inputEditor(); } },
                ...
                temp2: { name: 'temp2', label: '选择', value: '', editor: function () { return new myflow.editors.selectEditor([{ name: 'qqq', value: 1 }, { name: 'www', value: 2 }]); } }
            }
        },
        end: {
